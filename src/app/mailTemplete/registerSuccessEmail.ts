...
const registrationSuccessEmailBody = (name:string,activationCode:number) => `
  <html>
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to Carenes</h1>
        </div>
        <div class="content">
          <h2>Hello, ${name}</h2>

          <p>Thank you for registering with Carenes. To activate your account, please use the following activation code:</p>
        ...
        <div class="footer">
          <p>&copy; ${new Date().getFullYear()} Carenes. All rights reserved.</p>
