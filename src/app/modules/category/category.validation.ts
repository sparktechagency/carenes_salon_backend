...
const createCategoryValidationSchema = z.object({
  body: z.object({
    ...
    appointmentColor:z.string({required_error:"Appointment color is required"}),
  }),
});
const updateCategoryValidationSchema = z.object({
  body: z.object({
    categoryName: z
      .string({ required_error: 'Category name is required' })
      .min(1, 'Category name is required').optional(),
    appointmentColor:z.string({required_error:"Appointment color is required"}).optional(),
  }),
});
